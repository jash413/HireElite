...
export const faqData: FAQItem[] = [
  {
    question: "How fast can I hire software developer talent in New York with HireElite?",
    answer: `Our global IT recruitment community in New York has millions of connections with software developers, so you can expect to get a list of the best software candidates available in your city, country, or worldwide within 72 hours after posting your vacancy on HireElite. When you need to hire software engineers quickly, we deliver results.`
  },
  {
    question: "Do you provide freelance software developers when I hire a software programmer?",
    answer: `At HireElite, we focus on building long-lasting relationships between our clients and tech specialists. You are free to hire software developer talent for dedicated roles. However, our recruiters can provide you with both on-site and remote freelance specialists to extend your software development team in New York.`
  },
  {
    question: "What soft skills should I look for when I hire software engineers in New York long-term?",
  ...
  {
    question: "What do I need to start hiring developers in New York with HireElite?",
  ...
  {
    question: "How can HireElite help me with the hiring process when I hire software engineers in New York?",
  ...
  {
    question: "What are some tips for hiring developers from New York fast and easy?",
  ...
  {
    question: "How much does it cost to hire software engineers in New York on HireElite?",
  ...
  {
    question: "How does HireElite pre-screen software developers from New York?",
  ...
  {
    question: "How is HireElite different from job boards when I hire a software programmer?",
