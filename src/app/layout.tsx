...
export const metadata: Metadata = {
  title: {
    default:
      "Hire Software Developer - Top JavaScript & TypeScript Talent in New York | HireElite",
  ...
  openGraph: {
    title:
      "Hire Software Developer - Top JavaScript & TypeScript Talent in New York",
    description:
      "Hire software developer talent in New York. Expert JavaScript, TypeScript, React, and Node.js developers with risk-free trial period.",
...
export default function RootLayout({
  ...
  const structuredData = {
    ...
    description:
      "Hire software developer talent in New York. Expert JavaScript, TypeScript, React, and Node.js developers.",
    address: {
      "@type": "PostalAddress",
    ...
    service: {
      ...
      description:
        "Professional software developer recruitment and hiring services",
      provider: {
        "@type": "Organization",
        name: "HireElite",
      },
