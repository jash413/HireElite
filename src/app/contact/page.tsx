  ...
  const features = [
    {
      ...
      description: 'Get a response within 10 minutes during business hours'
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: '1-week trial period with money-back guarantee'
    },
    {
      icon: Zap,
      title: 'Quick Start',
      description: 'Developers can start within 48 hours'
    }
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
            Ready to Hire <GradientText>Elite Developers?</GradientText>
          </h1>
          
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
            Get started with New York's premier software development talent. 
            Contact us today for a free consultation and 25% off your first month.
          </p>
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-16">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-8">
              ...
              with a customized solution for your development needs.
            </p>
            <ContactForm />
          </div>
